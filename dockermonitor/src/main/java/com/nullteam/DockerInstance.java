...
public class DockerInstance {
    ...
    public void pauseContainer() {
        PauseContainerCmd pauseContainerCmd = ClientUpdater
    ...
    public void unpauseContainer() {
        UnpauseContainerCmd unpauseContainerCmd = ClientUpdater
    ...
    public static String chooseAnActiveContainer() {
        ...
        for (DockerInstance c :containerslist) {
            //if the status starts with "Up" it means the container is active
            if (c.getContainerStatus().startsWith("Up")) {
        ...
        return containerslist.get(containerslist
                .indexOf(actives.get(answer - 1))).getContainerId();
    }
    /**
    ...
    public static String chooseAStoppedContainer() { //returns container's id
        ...
        int answer = in.nextInt();
        return containerslist.get(containerslist
                .indexOf(stopped.get(answer - 1))).getContainerId();
    }
    ...
    public static String chooseAPausedContainer() { //returns container's id
        ...
        int answer = in.nextInt();
        return containerslist.get(containerslist
                .indexOf(paused.get(answer - 1))).getContainerId();
    }
    ...
    public static String chooseAnUnpausedContainer() { //returns container's id
        ...
        int answer = in.nextInt();
        return containerslist.get(containerslist
                .indexOf(unpaused.get(answer - 1))).getContainerId();
    }
    /**
    ...
    // User presses STOP and there are no Active Containers,
